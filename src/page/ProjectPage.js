...
export default function ProjectPage(){
    return <div>
            ...
            <table  style={{color:"#696969"}}>
                <tr>
                    <div>
                        <h2>Michael personal website: Build by utilizing React.js:</h2>
                        <img src={michaelweb}
                            style={{
                ...
                <tr>
                    <h2>Website「華佗日誌」: </h2>
                        ...
                        <tr>
                                <h2>AVT DESIGSN internal accounting website: </h2>
                                <img src={AVT}
                                    style={{
                                        width: '70vw', // 50% of the viewport width
                                        height: '70vh', // 25% of the viewport height
                ...
                <tr>
                    <h2 >Ecommerce-Analytics Website:</h2>
